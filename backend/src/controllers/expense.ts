...
export async function create(req: Request, res: Response) {
    ...
    if (response instanceof Error) {
        return res.status(HttpStatus.BAD_REQUEST).send(new ApiResponse(EXPENSE_CREATE_REQUEST, EXPENSE_CREATE_MESSAGE_FAIL, HttpStatus.BAD_REQUEST, {}, response.message));
    } else {
