...
export async function index(req: Request, res: Response) {
	...
	if (response instanceof Error) {
		...
		return res.send(
			new ApiResponse(EXPENSE_INDEX_REQUEST, EXPENSE_INDEX_SUCCESS, HttpStatus.OK, response)
		);
	}
}
...
export async function show(req: Request, res: Response) {
	...
	if (response instanceof Error) {
		return res
			...
			.send(
				new ApiResponse(
					EXPENSE_SHOW_REQUEST,
					EXPENSE_SHOW_MESSAGE_FAIL,
					HttpStatus.BAD_REQUEST,
					{},
					response.message
				)
...
export async function create(req: Request, res: Response) {
	...
	if (response instanceof Error) {
		...
		return res.send(
			new ApiResponse(
				EXPENSE_CREATE_REQUEST,
				EXPENSE_CREATE_MESSAGE_SUCCESS,
				HttpStatus.OK,
				true
			)
		);
...
export async function update(req: Request, res: Response) {
	...
	if (response instanceof Error) {
		...
		return res.send(
			new ApiResponse(EXPENSE_UPDATE_REQUEST, EXPENSE_UPDATE_SUCCESS, HttpStatus.OK, true)
		);
	}
}
...
export async function remove(req: Request, res: Response) {
	...
	if (response instanceof Error) {
		...
		return res.send(
			new ApiResponse(
				EXPENSE_REMOVE_REQUEST,
				EXPENSE_REMOVE_MESSAGE_SUCCESS,
				HttpStatus.OK,
				true
			)
		);
