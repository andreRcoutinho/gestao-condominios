export const USER_NOT_EXISTS = "Utilizar inexistente";
...
export const UNITS_EMPTY = "Ainda não existem unidades na base de dados";
export const UNIT_NOT_EXISTS = "Unidade inexistente";
